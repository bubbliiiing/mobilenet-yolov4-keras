...
if __name__ == "__main__":
    ...
    #   训练自己的数据集时提示维度不匹配正常
    #   预测的东西都不一样了自然维度不匹配
    #   yolov4_mobilenet_v1_1.0
    #   yolov4_mobilenet_v2_1.0
    #   yolov4_mobilenet_v3_1.0
    #   yolov4_mobilenet_v1_0.25
    #------------------------------------------------------#
    weights_path = 'model_data/yolov4_mobilenet_v1_voc_map77.57.h5'
