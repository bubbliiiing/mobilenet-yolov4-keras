...
from utils.callbacks import LossHistory, ExponentDecayScheduler, WarmUpCosineDecayScheduler
...
if __name__ == "__main__":
    ...
    #   创建yolo模型
    #------------------------------------------------------#
    model_body  = yolo_body((None, None, 3), anchors_mask, num_classes, backbone, alpha)
    if model_path != '':
        #------------------------------------------------------#
        #   载入预训练权重
        #------------------------------------------------------#
